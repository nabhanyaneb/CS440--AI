...
def highest_state(game, current): #returns state with highest probability of currently being the moving target based on observations so far
    ...
    #keep track of which states are within 5 manhattan distance of the current state
    is_five = False
